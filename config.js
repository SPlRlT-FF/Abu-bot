...
module.exports = {
    ...
    PLK: process.env.OWNER_NAME === undefined ? '𝑨𝑩𝑼 𝑺𝑬𝑹' : process.env.OWNER_NAME,
    ...
    LOGOSK: process.env.ALL_IMG === undefined ? 'https://i.imgur.com/EDaV4za.jpeg' : process.env.ALL_IMG,
