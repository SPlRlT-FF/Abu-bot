...
module.exports = {
    ...
    AFN: process.env.ALL_CAPTION === undefined ? 'ᴍᴀᴅᴇ ʙʏ ᴀʙᴜ ʙᴏᴛ࿐' : process.env.ALL_CAPTION,
    ...
    PLK: process.env.OWNER_NAME === undefined ? '𝗔𝗕𝗨𝗦𝗘𝗥' : process.env.OWNER_NAME,
    ...
    BOTSK: process.env.BOT_NAME === undefined ? 'ꪶ͢ɪͥᴛͭsᷤ ͢ᴍͫᴇͤᡃ⃝ᴀʙᴜ ʙᴏᴛ࿐' : process.env.BOT_NAME,
    LOGOSK: process.env.ALL_IMG === undefined ? 'https://i.ibb.co/QDpVJ7m/IMG-20220120-WA0097.jpg' : process.env.ALL_IMG,
    SLINK: process.env.SOCIAL_MEDIA === undefined ? 'https://www.instagram.com/Abu_ser' : process.env.SOCIAL_MEDIA,
    ...
    SUDO: process.env.SUDO === undefined ? '919496306657,0' : process.env.SUDO,
    DEBUG: DEBUG,
